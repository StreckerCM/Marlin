...
//
#if NONE(SKRMiniE3V2, SKRE3Turbo)
 ...
 */
  ...
  #if NONE(SKRMiniE3V2, SKRE3Turbo) && ENABLED(EasterBunny)
...
#define BABYSTEPPING
  ...
  #define DOUBLECLICK_FOR_Z_BABYSTEPPING  // Double-click on the Status Screen for Z Babystepping.
    ...
    #if DISABLED(SKRMiniE3V2) && ENABLED(GraphicLCD)
 ...
 */
#if DISABLED(SKRMiniE3V2) && ENABLED(SKR_UART)
  #define LIN_ADVANCE
#endif
 ...
 */
#if ENABLED(ABL_BI) && DISABLED(SKRMiniE3V2)
 ...
 */
  ...
  #if AXIS_IS_TMC(X)
    #define X_CURRENT       825        // (mA) RMS current. Multiply by 1.414 for peak current.
  ...
  #if AXIS_IS_TMC(Y2)
    #define Y2_CURRENT      STEPPER_Y_CURRENT
