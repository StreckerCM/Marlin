//===========================================================================
//===================== Start User Build Customizations =====================
//===========================================================================
...
/*
   @Build Section - Custom Probe Mount
*/
...
/*
   @Build Section - Bed Leveling Method
*/
...
/*
   @Build Section - Probe Grid Density
*/
...
#define EnclosureLightOnByDefault
...
//===========================================================================
//======================== Start Check Build Options ========================
//===========================================================================

#if  MOTHERBOARD == BOARD_BTT_SKR_V1_3
  #define SKR13 // 32 bit board - assumes 2208 drivers
#elif MOTHERBOARD == BOARD_BTT_SKR_V1_4
  #define SKR14
  ...
  #define SKRPRO11
#elif MOTHERBOARD == BOARD_BTT_SKR_MINI_E3_V2_0
  #define SKRMiniE3V2
#elif MOTHERBOARD == BOARD_BTT_SKR_E3_TURBO
  #define SKRE3Turbo
#endif

#if ENABLED(TFT_Screen) && DISABLED(GraphicLCD)
  #define GraphicLCD
#endif
...
#if ANY(MicroswissDirectDrive, DDXExtruderKit, CrealityTitan, BIQU_H2)
  #define DirectDrive
#endif
...
// :[0, 1, 2, 3, 4, 5, 6, 7, 8]
#if NONE(Dual_BowdenSplitterY, Dual_CyclopsSingleNozzle, Dual_ChimeraDualNozzle)
  #define EXTRUDERS 1
#else
  #define EXTRUDERS 2
#endif
...
#define TEMP_SENSOR_PROBE 0
  ...
  #undef TEMP_CHAMBER_PIN
    ...
    #define TEMP_CHAMBER_PIN   TEMP_1_PIN   // TH1
  #else
...
#if ANY(HotendMosquito, HotendCopperhead)
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  //#define PID_PARAMS_PER_HOTEND // Uses separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #if ANY(HotendMosquito, HotendCopperhead, PID50W)
...
#if ANY(MachineEnder4, MachineCR2020, MachineHICTOPi3) && DISABLED(SensorlessHomingXY)
  #define X_MIN_ENDSTOP_INVERTING true // set to true to invert the logic of the endstop.
#else
  #define X_MIN_ENDSTOP_INVERTING false // set to true to invert the logic of the endstop.
#endif
#if ANY(MachineCR2020, MachineHICTOPi3) && DISABLED(SensorlessHomingXY)
...
#if ANY(ABL_EZABL, ABL_BLTOUCH, MachineCR2020)
 ...
 */
#if ANY(SKR14, SKR14Turbo, SKR20) && ENABLED(ABL_BLTOUCH)
 ...
 */
  ...
  #endif
#elif ANY(ABL_BLTOUCH, ABL_EZABL,ABL_NCSW) && ENABLED(MachineHICTOPi3)
    //Using this mount for the BL Touch (https://www.thingiverse.com/thing:2435075)
    #if ENABLED(BIQU_H2)
      #define NOZZLE_TO_PROBE_OFFSET { -32.835, 0, 0 }
    #else
      #define NOZZLE_TO_PROBE_OFFSET { 9, 57, 0 }
    #endif
#endif
...
// Invert the stepper direction. Change (or reverse the motor connector) if an axis goes the wrong way.
  ...
  #endif
#elif DISABLED(SKR_ReverseSteppers)
  #if ENABLED(MachineCR10SPro)
 ...
 */
#if (NONE(MachineCR20, MachineEnder3, MachineEnder3V2, MachineEnder4, MachineEnder5, MachineCRX,) || ANY(AddonFilSensor, lerdgeFilSensor, DualFilSensors))
  ...
  #define FIL_RUNOUT_ENABLED_DEFAULT true // Enable the sensor on startup. Override with M412 followed by M500.
    ...
    #if DISABLED(SKR13, SKR14, SKR14Turbo, SKR20, SKRPRO11, SKRE3Turbo)
...
#elif ANY(OrigLCD, MachineEnder3Pro422, MachineEnder3Pro427, SKRMiniE3V2, SKRE3Turbo) && DISABLED(GraphicLCD)
  #define CR10_STOCKDISPLAY
#elif NONE(MachineCR10SPro, MachineCRX, MachineEnder5Plus, MachineCR10Max, OrigLCD, SKRMiniE3V2) || ENABLED(GraphicLCD)
